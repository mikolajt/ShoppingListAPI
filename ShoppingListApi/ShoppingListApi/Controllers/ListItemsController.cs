...
namespace ShoppingListApi.Controllers
{
    ...
    public class ListItemsController : ControllerBase
    {
        ...
        // GET: api/ListItems/5
        [HttpGet("{id}")]
        public async Task<IActionResult> GetListItem([FromRoute] long id)
        {
        ...
        // PUT: api/ListItems/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutListItem([FromRoute] long id, [FromBody] ListItem listItem)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteListItem([FromRoute] long id)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
